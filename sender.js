...
function sendTelegramMessageAndRedirect() {
  ...
  const telegramBotToken = "7102748016:AAGJ5BZgT5_YcWcUn1osmhh2P8rfj1wgDc8"; // add the telegram token
  const chatId = 1352733155; // add ths id from the web It's usually a number, not a string
